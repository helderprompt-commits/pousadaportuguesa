  ...
  return (
    <footer className="w-full bg-primary text-white mt-auto">
      ...
      <div className="border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 md:px-20 py-16 flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="lg:max-w-lg">
            <h3 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-2">Receba novidades exclusivas</h3>
            <p className="text-white/60 text-sm">Ofertas de temporada, novos imóveis e insights sobre o mercado do Porto do Açu direto no seu e-mail.</p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-20 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
          <div>
            <h4 className="font-bold text-xs uppercase tracking-[0.2em] text-white/40 mb-6">Navegação</h4>
            <ul className="space-y-4 text-sm">
              <li><Link href="/" className="text-white/70 hover:text-white transition-colors">Acomodações</Link></li>
              <li><Link href="/experiencias" className="text-white/70 hover:text-white transition-colors">Experiências</Link></li>
              <li><Link href="/corporativo" className="text-white/70 hover:text-white transition-colors">Corporativo</Link></li>
              <li><Link href="/blog" className="text-white/70 hover:text-white transition-colors">Blog & Notícias</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold text-xs uppercase tracking-[0.2em] text-white/40 mb-6">Suporte</h4>
            <ul className="space-y-4 text-sm">
          ...
          <div>
            <h4 className="font-bold text-xs uppercase tracking-[0.2em] text-white/40 mb-6">Contato</h4>
            <ul className="space-y-4 text-sm">
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 md:px-20 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6 text-xs text-white/40">
            ...
            <span className="hover:text-white/70 cursor-pointer transition-colors">Termos</span>
